...
classes = [
    ...
    modules.anim_data.SUB_OP_mat_property_shift_up,
    modules.anim_data.SUB_OP_mat_property_shift_down,
    ...
    modules.anim_data.SUB_OP_vis_entry_shift_up,
    modules.anim_data.SUB_OP_vis_entry_shift_down,
