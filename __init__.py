...
classes = [
    ...
    panels.export_model.SUB_PT_export_model,
    panels.export_model.SUB_OP_model_exporter,
    panels.export_model.SUB_OP_vanilla_nusktb_selector,
    panels.exo_skel.SUB_OP_build_bone_list,
    panels.exo_skel.SUB_OP_populate_bone_list,
    panels.exo_skel.SUB_OP_update_bone_list,
    panels.exo_skel.SUB_OP_rename_other_bones,
    panels.exo_skel.SUB_PT_ultimate_exo_skel,
    panels.exo_skel.BoneListItem,
    panels.exo_skel.PairableBoneListItem,
    panels.exo_skel.SUB_UL_BoneList,
    panels.exo_skel.SUB_OP_make_combined_skeleton,
    ...
    panels.helper_bone_data.SUB_PT_helper_bone_data_master,
    panels.helper_bone_data.SUB_PT_helper_bone_data_aim_entries,
    panels.helper_bone_data.SUB_PT_helper_bone_data_interpolation_entries,
    panels.helper_bone_data.SUB_PT_helper_bone_data_version_info,
    panels.helper_bone_data.SUB_UL_aim_entries,
    panels.helper_bone_data.SUB_UL_interpolation_entries,
    panels.helper_bone_data.SUB_OP_add_interpolation_entry,
    panels.helper_bone_data.SUP_OP_helper_bone_constraints_remove,
    panels.helper_bone_data.SUP_OP_helper_bone_constraints_refresh,
    panels.helper_bone_data.SUB_MT_interpolation_entry_context_menu,
    panels.helper_bone_data.AimEntry,
    panels.helper_bone_data.InterpolationEntry,
    panels.helper_bone_data.SubHelperBoneData,
    panels.reimport_materials.SUB_PT_reimport_materials,
    panels.reimport_materials.SUB_OP_mat_reimport_directory_selector,
    panels.reimport_materials.SUB_OP_mat_reimport_numatb_selector,
    panels.reimport_materials.SUB_OP_reimport_materials,
